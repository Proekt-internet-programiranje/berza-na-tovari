...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2018 at 11:40 PM
...
(42, 4, 'QWERTY', 'c4ca4238a0b923820dcc509a6f75849b'),
(43, 4, 'QWERTY1', 'c4ca4238a0b923820dcc509a6f75849b'),
(44, 4, 'dsfs', 'd9729feb74992cc3482b350163a1a010'),
(45, 4, 'aaaaaaaaaaaaaaaaaaaaaaaaaa', 'c4ca4238a0b923820dcc509a6f75849b'),
(46, 4, 'BBBBBBBBBBB', 'c4ca4238a0b923820dcc509a6f75849b'),
(47, 4, 'D', 'c4ca4238a0b923820dcc509a6f75849b'),
(48, 4, 'POLIKASDSAD', 'c4ca4238a0b923820dcc509a6f75849b');
...
INSERT INTO `lokacija` (`id_vozac`, `Latitude`, `Longitude`) VALUES
(47, '41.7374623', '22.204844299999998'),
(48, '0', '0');
...
(44, 29, 'sdfsd', 'sdf', ''),
(45, 29, 'AAAAAAAAAAAAA', 'v', ''),
(46, 29, 'BBBBBBBBBBBBBB', 'BBBBBBBBBBB', ''),
(47, 29, 'DDDDDDDDDDD', 'DDDDDDDDD', ''),
(48, 12, 'POLIKASDSAD', 'B', 'ne');
...
INSERT INTO `vozilo` (`id_vozilo`, `id_kompanija`, `tip_na_vozilo`, `euro_standard`, `broj_na_sasija`, `tip_na_prikolka`, `registracija`, `ima_tura`) VALUES
(1, 12, 1, 5, 13133, 'asdasd', '1232131', 'ne'),
(2, 29, 1, 213123, 123123, '123', '123', 'ne');
...
--
ALTER TABLE `korisnici`
  MODIFY `id_korisnik` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `lokacija`
--
ALTER TABLE `lokacija`
  MODIFY `id_vozac` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `lokacija`
  ADD CONSTRAINT `lokacija_ibfk_1` FOREIGN KEY (`id_vozac`) REFERENCES `korisnici` (`id_korisnik`);
