...
INSERT INTO `kompanija` (`id_kompanija`, `id_tipkompanija`, `imekompanija`, `danocen_broj`, `e-mail`, `adresa`, `telefon`) VALUES
(1, 2, 'DHL', 0, '', '', 0);
...
--
ALTER TABLE `kompanija`
  MODIFY `id_kompanija` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
